...
function ExpenseForm({ onCancel, onSubmit, submitButtonLabel, initialValues }) {
  const [inputs, setInputs] = useState({
    amount: {
      value: initialValues ? initialValues.amount.toString() : "",
      isValid: true, //set as true now to prohibit initial error, will change on validity check upon submit
    },
    date: {
